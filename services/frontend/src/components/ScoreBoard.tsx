      ...
      >
        ...
        <div className="scoreboard__ranking">
          {ranking.map(([name, score], idx) => (
            <div
              key={name}
              className={`scoreboard__row ${name === playerName ? "scoreboard__row--me" : ""}`}
            >
        ...
        <p className="scoreboard__my-score">
          あなたの取り枚数: <strong>{myScore} 枚</strong>
        </p>
        ...
        <button
          type="button"
          className="scoreboard__again-btn"
          onClick={onPlayAgain}
        >
          ロビーに戻る
        </button>
